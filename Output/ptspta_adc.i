...
unsigned int Sum=0, L_StarInAdc_Tmp = 0;
    ...
    unsigned int   u32ConversionData;
            ...
            {
               	 u32ConversionData = (((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(u32ChannelCount)] & (0xFFFFul << 0))>>0);

			if(u32ChannelCount == 0)
			{
				G_Current = u32ConversionData;
				gu32Current =  (u32ConversionData * 32105)/1000;
