...
#line 18 "Source\\PtsPta_NVRAM.c"


#line 593 "Source\\PtsPta_NVRAM.c"
...
void Write_24LC02( unsigned char address, unsigned char data, unsigned char *EEPROM_STATUS )
{
	...
	while(1)
	{
		...
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 1, 0, 0, 0);	
		...
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = 0XA0;					
		...
		if((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS)==0x20)
			*EEPROM_STATUS = 0x20; 
		else
			*EEPROM_STATUS = 0xff;
		...
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = address&0XFF;	
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 1); 
		while( ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON) & (1ul << 3)) == 0 )			
		{
				++L_Count;
				if( L_Count >= 10000 )
		...
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = data;					
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 1); 
		while( ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON) & (1ul << 3)) == 0 )			
		{
				++L_Count;
	...
	while(1)
	{
		...
		if((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS)==0x30)
			...
			*EEPROM_STATUS = 0xff;
			...
			((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = 0XA1;
			I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 1);    
			while( ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON) & (1ul << 3)) == 0 )			   
			{
					++L_Count;
		...
		if((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS)==0x48)
			*EEPROM_STATUS = 0x48; 
		else
			*EEPROM_STATUS = 0xff;
			...
			TEMP= ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT;
...
((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = DevAddr;
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);	   
...
CLK_SysTickLongDelay(300);
		...
		if( ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0xF8 )			
		{
		...
		else if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x20)
		{
		...
		else if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x18 )	
		{
